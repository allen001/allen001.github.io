    ...
    timedAction(function (index) {
      ...
      switch (action) {
		...
		case 'Date':
          ...
          if (month >= 1 && month <= 9) { month="0" + month; } if (strdate>= 0 && strDate <= 9) { strdate="0" + strdate; } var currentdate="date.getFullYear()" +" "+ month "+strdate; s.shape.switchshape(s.shapebuilder.letter(currentdate)); break; case 'time': t="formatTime(new" date()); if (sequence.length> 0) {
